...
import { PrismaClient } from "./prismaClient.generated.js";
 ...
 *
 * Runtime uses the committed `prismaClient.generated.js` bundle so Vercel
 * does not depend on importing gitignored `generated/prisma/*.ts` files.
 * Refresh the bundle with: npm run prisma:bundle
 */
