...
export function prismaPublicError(error) {
  ...
  if (/prismaClient\.generated\.js|client\.runtime\.js/i.test(err.message)) {
    return "Apex database client JS bundle is missing from the deploy. Commit lib/prismaClient.generated.js and redeploy hotcol-admin-backend.";
  }
